...
class ChatMessage(object):
    ...
    def to_unified_message(self, channel: str, mapped_keys: Optional[Iterable[str]] = None) -> UnifiedMessage:
        """Convert ChatMessage into channel-agnostic UnifiedMessage for downstream services."""
        return UnifiedMessage.from_chat_message(self, channel=channel, mapped_keys=mapped_keys)
