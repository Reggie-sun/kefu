...
available_setting = {
    ...
    # Smart Gateway 配置
    "smart_gateway_enabled": False,
    "smart_gateway_base_url": "http://localhost:8500",
    "smart_gateway_timeout": 15,
    "smart_gateway_tools_allowed": [],
    "smart_gateway_rag_top_k": 3,
    "smart_gateway_rag_threshold": 0.3,
    # Customer service RAG upstream (external service)
    "customer_service_api_base_url": "",
    "customer_service_api_token": "",
    "customer_service_api_timeout": 8.0,
    # chatgpt会话参数
